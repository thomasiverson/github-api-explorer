  ...
  return (
    <header className="h-12 flex items-center px-4 border-b border-border bg-panel shrink-0 gap-4">
      ...
      <a href="/" className="flex items-center gap-2 mr-2 hover:opacity-80 transition-opacity">
        ...
        <span className="font-semibold text-sm text-text-primary">GitHub REST API Test Harness</span>
      </a>
      ...
      <nav className="flex items-center gap-1">
        <a href="/history" className="px-3 py-1 text-sm text-text-secondary hover:text-text-primary hover:bg-surface rounded-md transition-colors">
          History
        </a>
        <a href="/collections" className="px-3 py-1 text-sm text-text-secondary hover:text-text-primary hover:bg-surface rounded-md transition-colors">
          Collections
        </a>
